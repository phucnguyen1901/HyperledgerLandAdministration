...
async function main(userId) {
    try {
        ...
        const contract = network.getContract('fabcar','TokenERC20Contract');
        ...
        if(result){
            console.log("Get ClientAccountID Successfully")
        }else{
            console.log("Not Get ClientAccountID Successfully")
        }
